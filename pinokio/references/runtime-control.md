---
name: pinokio
description: Discover, launch, use, and when explicitly requested create/debug Pinokio apps and launchers with pterm-first runtime control.
---
...
For creating or editing launcher scripts, load `references/launcher-development.md` after resolving the target app. Keep this main file focused on runtime control.
