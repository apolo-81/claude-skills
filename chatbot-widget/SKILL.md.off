...
description: >
  ...
  Do NOT use for: bots de WhatsApp o mensajería externa (usar wa-baileys + express-api),
  integraciones GHL sin interfaz web (usar ghl-integration),
  bots CLI sin interfaz web visible.
---
