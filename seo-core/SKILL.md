...
name: seo-core
description: >
  Performs complete technical SEO audits: crawlability, indexation, Core Web Vitals,
  JS rendering, robots.txt, canonical, redirects, security, IndexNow. Main engine that
  orchestrates subagents for parallel analysis. Usar cuando: "SEO", "auditoría SEO",
  "technical SEO", "Core Web Vitals", "LCP", "INP", "CLS", "page speed", "Googlebot",
  "no aparezco en Google", "robots.txt", "canonical tags", "crawl budget", "reporte SEO",
  "diagnóstico del sitio". Triggers in English: "noindex problems", "mobile-first indexing",
  "Googlebot rendering", "site not indexed", or sharing a URL for general SEO analysis.
---
