...
> **Nota de disponibilidad:** `market-audit` y `market-competitors` requieren que el grupo `market` esté activo. Si no responden, ejecutar `/skills on market` y `/reload-plugins`.
