...
description: >
  ...
  Do NOT use for: apps sin billing ni suscripciones (usar supabase-stack directamente),
  backends Express sin frontend Next.js (usar express-api + auth-patterns),
  prototipos internos sin monetización planificada.
---
