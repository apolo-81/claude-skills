...
description: >
  ...
  Do NOT use for: contenido que solo el dev editará (usar MDX en el repo),
  blogs simples sin edición del cliente (usar archivos .md en /content/),
  datos estructurados que vienen de una DB propia (usar Prisma/Supabase directamente).
---
